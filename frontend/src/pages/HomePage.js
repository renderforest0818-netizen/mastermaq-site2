...
export default function HomePage() {
  ...
  return (
    <div data-testid="home-page">
      ...
      {/* ══════════════════════════════════════════════════════════
          DEPOIMENTOS — Citacao destaque + grid
         ══════════════════════════════════════════════════════════ */}
              ...
              <div className="bg-white border border-slate-200 p-10 sm:p-12 relative overflow-hidden group hover:shadow-xl transition-shadow duration-400">
                ...
                <div className="relative z-10">
                  <div className="flex gap-0.5 mb-6">
                    {Array.from({ length: TESTIMONIALS[0].rating }).map((_, j) => <Star key={j} className="w-5 h-5 fill-yellow-400 text-yellow-400" />)}
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-heading font-semibold text-sm text-slate-900">{TESTIMONIALS[0].name}</p>
                      <p className="text-xs text-slate-400">{TESTIMONIALS[0].city}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              {TESTIMONIALS.slice(1).map((t, i) => (
                <motion.div key={t.name} initial="hidden" whileInView="visible" viewport={{ once: true }}
                  variants={{ ...fadeRight, visible: { ...fadeRight.visible, transition: { duration: 0.7, delay: i * 0.15 } } }}
                  className="bg-white border border-slate-200 p-7 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-slate-200 flex items-center justify-center text-slate-600 font-heading font-semibold text-sm">
                      {t.name.charAt(0)}
                    </div>
                    <div>
