        ...
        <div className="flex items-center justify-between h-16 sm:h-[68px]">
          ...
          <Link to="/" className="flex items-center gap-2" data-testid="header-logo">
            <img
              ...
              alt="Mastermaq"
              className={`h-9 sm:h-10 w-auto transition-all duration-300 ${!scrolled && isHome ? 'brightness-0 invert' : ''}`}
            />
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className={`flex items-center gap-1.5 text-[13px] transition-colors duration-200 ${
                !scrolled && isHome ? 'text-white/70 hover:text-white' : 'text-slate-500 hover:text-blue-600'
              }`}
            ...
            {user ? (
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  size="icon"
                  onClick={logout}
                  className={`${!scrolled && isHome ? 'text-white/60 hover:text-red-400' : 'text-slate-500 hover:text-red-600'}`}
          ...
          {/* Mobile Toggle */}
          <button
            className={`md:hidden p-2 ${!scrolled && isHome ? 'text-white' : 'text-slate-600'}`}
